...
POSES = {
    ...
    # 左手敬礼：hand → (0.10, 0.10, 0.82) 最高可达到点，大臂超肩
    "左手敬礼":
        [-2.54, 0.13, -0.34, -0.75, -0.02, 0.21, -0.04] + READY[7:],

    # 右手敬礼：hand → (0.10, -0.10, 0.82) 最高可达到点
    "右手敬礼":
        READY[:7] + [-2.54, -0.13, 0.34, -0.75, 0.02, 0.21, 0.04],
